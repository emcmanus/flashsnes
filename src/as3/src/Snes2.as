package
{
	...
	public class Snes2 extends Sprite
	{
		// Config
		...
		private function onRomLoaded(e:Event):void
		{
			...
			// Interface
			emulatorControl = new EmulatorControl( emulator );
			performance = new Performance();
			
			// Show
			addChild( screen );
			addChild( performance );
			addChild( emulatorControl );
