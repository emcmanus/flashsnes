...
//	AddBoolC("Mode7Interpolate", Settings.Mode7Interpolate, true, "true for bi-linear filter mode7"); // NYI
	...
	AddBoolC("DisplayFrameCount", GFX.FrameDisplay, true, "true to show the frame count when a movie is playing");
#undef CATEGORY
#define CATEGORY "Display\\Win"
	...
	AddBoolC("Stretch:UseVideoMemory", GUI.VideoMemory, true, "allows bilinear filtering of stretching. Depending on your video card and the window size, this may result in a lower framerate.");
...
#define	CATEGORY "Sound"
	...
	AddBool("FixFrequency", Settings.FixFrequency, true);
