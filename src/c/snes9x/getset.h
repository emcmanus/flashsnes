...
#ifdef SPC7110_DEBUG
        S9xTracef( "Print f: reading spc7110 ROM (byte) at %06X\n", Address);
#endif
        return S9xGetSPC7110Byte(Address);

      case CMemory::MAP_SPC7110_DRAM:
#ifdef SPC7110_DEBUG
        S9xTracef( "Print f: reading Bank 50 (byte)\n");
#endif
...
#ifdef DEBUGGER
        S9xTracef( "Print f: DEBUG R(B) %06x\n", Address);
#endif
      default:
...
#endif
{
    ...
    switch ((pint) GetAddress)
    {
      ...
      case CMemory::MAP_DSP:
        ...
        S9xTracef( "Print f: Get DSP Word @ %06X\n", Address);
#endif
        return (S9xGetDSP (Address & 0xffff) |
      ...
      case CMemory::MAP_SPC7110_ROM:
#ifdef SPC7110_DEBUG
        S9xTracef( "Print f: reading spc7110 ROM (word) at %06X\n", Address);
#endif
        return (S9xGetSPC7110Byte(Address)|
                (S9xGetSPC7110Byte (Address+1))<<8);
      case CMemory::MAP_SPC7110_DRAM:
#ifdef SPC7110_DEBUG
        S9xTracef( "Print f: reading Bank 50 (word)\n");
#endif
        return (S9xGetSPC7110(0x4800)|
      ...
      case CMemory::MAP_DEBUG:
#ifdef DEBUGGER
        S9xTracef( "Print f: DEBUG R(W) %06x\n", Address);
#endif
      default:
      case CMemory::MAP_NONE:
...
INLINE void S9xSetByte (uint8 Byte, uint32 Address)
{
    ...
    switch ((pint) SetAddress)
    {
      ...
      case CMemory::MAP_DSP:
#ifdef DSP_DUMMY_LOOPS
        S9xTracef( "Print f: DSP Byte: %02X to %06X\n", Byte, Address);
#endif
     ...
     case CMemory::MAP_HIROM_SRAM:
      ...
      case CMemory::MAP_SPC7110_DRAM:
#ifdef SPC7110_DEBUG
        S9xTracef( "Print f: Writing Byte at %06X\n", Address);
#endif
...
#endif
{
    ...
    switch ((pint) SetAddress)
    {
      ...
      case CMemory::MAP_DSP:
#ifdef DSP_DUMMY_LOOPS
        S9xTracef( "Print f: DSP Word: %04X to %06X\n", Word, Address);
#endif
        if(o){
      ...
      case CMemory::MAP_SPC7110_DRAM:
#ifdef SPC7110_DEBUG
        S9xTracef( "Print f: Writing Word at %06X\n", Address);
#endif
...
//      case CMemory::MAP_SPC7110_DRAM:
#ifdef SPC7110_DEBUG
//        S9xTracef( "Print f: Getting Base pointer to DRAM\n");
#endif
//        {
//            return s7r.bank50;
//        }
      ...
      case CMemory::MAP_SPC7110_ROM:
#ifdef SPC7110_DEBUG
        S9xTracef( "Print f: Getting Base pointer to SPC7110ROM\n");
#endif
...
//      case CMemory::MAP_SPC7110_DRAM:
#ifdef SPC7110_DEBUG
//        S9xTracef( "Print f: Getting Mem pointer to DRAM\n");
#endif
//        {
...
//        }
      ...
      case CMemory::MAP_SPC7110_ROM:
#ifdef SPC7110_DEBUG
        S9xTracef( "Print f: Getting Mem pointer to SPC7110ROM\n");
#endif
