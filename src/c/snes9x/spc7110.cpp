...
#ifdef SPC7110_DEBUG
			S9xTracef( "Print f: Returned %02X\n", s7r.reg4800);
#endif
		}
		return s7r.reg4800;
	//table register low
...
//command/index/value of RTC (essentially, zero unless we're in read mode
	case 0x4841:
		...
		if(rtc_f9.init)
		{
			...
			rtc_f9.index%=0x10;
#ifdef SPC7110_DEBUG
			S9xTracef( "Print f: $4841 returned %02X\n", tmp);
#endif
			return tmp;
		}
		else return 0;
//RTC done flag
	...
	default:
#ifdef SPC7110_DEBUG
		S9xTracef( "Print f: Access to Reg %04X\n", Address);
#endif
		return 0x00;
	}
}
...
{
#ifdef SPC7110_DEBUG
	S9xTracef( "Print f: %04X written to, value %02X\n", Address, data);
#endif
	switch(Address)
	{
